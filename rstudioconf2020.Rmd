...
# Making Guides easy: scales' functions for breaks and labels

The scales package provides useful helper functions for formatting numeric data for all types of labels 

---
class: center, middle

# A generic formatter: `label_number`
+ This generic formatter offers consistency in behaviour and arguments across formatters
and offers additional functionality for international customization.
...
This makes 
By default, `label_number()` will take any numeric vector, round them to nearest whole
number, add spaces between every 3 digits and return a character vector 
...
label_number(
  big.mark = ".",
  decimal.mark = ",", 
  accuracy = .01)(c(12.3, 4, 12345.789, 0.0002))
```
